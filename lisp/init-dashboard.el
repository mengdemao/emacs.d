...
;; Dashboard
(setq doglock-dashboard t)
(setq doglock-display-icons t)
...
(use-package dashboard
  ...
  (setq dashboard-banner-logo-title "DOGLOCK EMACS - Enjoy Programming & Writing"
		...
		dashboard-footer (format "Powered by Meng De Mao, %s" (format-time-string "%Y"))
		...
		`(((,(when doglock-display-icons
				 (all-the-icons-octicon "mark-github" :height 1.1 :v-adjust 0.0))
			  "Homepage" "Browse homepage"
			  (lambda (&rest _) (browse-url doglock-homepage)))
			 (,(when doglock-display-icons
			 ...
			 (,(when doglock-display-icons
			  ...
			  "Update" "Update Doglock Emacs"
			  (lambda (&rest _) (doglock-update)))
			 (,(if doglock-display-icons
